        ...
        <div className="max-w-4xl px-4 mx-auto">
          <div className="flex justify-between space-x-7">
            <Link href="/">
              ...
              <Image src="/assets/tinku_kumar.jpeg" alt="tinku kumar" width={100} height={100} />
                <span className="ml-2 text-lg font-semibold text-gray-900">Tinku Kumar</span>
              </a>
            </Link>
            <div className="items-center hidden space-x-1 md:flex">
              <Link href="/blog">
                <a
                  className="px-2 py-1 font-semibold text-gray-700 transition-all duration-300 rounded hover:ring-2 ring-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary">Blog</a>
              </Link>
              <Link href="/projects">
                <a
                  className="px-2 py-1 font-semibold text-gray-700 transition-all duration-300 rounded hover:ring-2 ring-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary">Projects</a>
              </Link>
            </div>
            <Menu className="" >
